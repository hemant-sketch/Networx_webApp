...
import {getAllPosts, createPost, deletePost} from "../../config/redux/action/postAction/index.js";
                ...
                <div className={styles.scrollComponent}>
                    ...
                    <div className={styles.wrapper}>
                        <div className={styles.createPostContainer}>
                            ...
                            <textarea onChange={(e)=> setPostContent(e.target.value)} value={postContent} placeholder={"What's in your mind?"} className={styles.textAreaOfContent} name="" id=""/>
